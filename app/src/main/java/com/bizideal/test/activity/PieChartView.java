...
import com.bizideal.test.ScreenUtils;
import com.bizideal.test.Utility;
...
public class PieChartView extends View {
    ...
    private int[] mPieColors = new int[]{Color.parseColor("#FE6665"),Color.parseColor("#FED35A") };
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mPieItems != null && mPieItems.length > 0) {
            ...
            for (int i = 0; i < mPieItems.length; i++) {
               ...
               // canvas.drawText(itemPercentText, 150, 230, textPaint);
